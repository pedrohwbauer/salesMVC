...
namespace SalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(2, "Electronica");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            Seller s1 = new Seller(1, "Bob Brown", "bob_brown@gmail.com", 1000.0, new DateTime(1998, 4, 11), d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 3500.0, new DateTime(1979, 12, 31), d1);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 3000.0, new DateTime(1988, 1, 15), d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 4000.0, new DateTime(1993, 11, 30), d1);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", 2000.0, new DateTime(2000, 1, 9), d1);
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", 1500.0, new DateTime(1997, 3, 4), d1);
